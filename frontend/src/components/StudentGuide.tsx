...
const GUIDE_CATEGORIES: GuideCategory[] = [
  {
    id: 'start', title: 'מתחילים נכון', icon: '🚀', items: [
      ...
      },
      {
        ...
        keywords: 'נושא תת נושא פיזיקה בחירה',
      },
    ],
  },
  {
    id: 'modes', title: 'מצבי הלמידה', icon: '🧠', items: [
      ...
      {
        title: 'הסבר מושג',
        description: 'מסביר רעיון פיזיקלי בשפה פשוטה, עם דוגמאות, משמעות ונוסחאות.',
  ...
  },
  {
    id: 'tools', title: 'כלי עזר', icon: '🧰', items: [
      ...
      },
      {
        ...
        description: 'לאחר בחירת נושא עשויות להופיע סימולציות אינטראקטיביות שממחישות את התופעה הפיזיקלית.',
    ...
    id: 'history', title: 'שיחות והתקדמות', icon: '📈', items: [
      {
        ...
        tips: ['תנו לשיחה שם שמכיל את הנושא והתרגיל.', 'צרו תיקיות לפי פרקים, למשל מכניקה או חשמל.', 'חזרו לשיחות שבהן טעיתם לפני מבחן.'],
