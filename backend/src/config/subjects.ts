...
- כל פעולה נדרשת חייבת להופיע בשלב נפרד; אין לקצר את הדרך בתוך explanation.
...
- הצג ב-steps[] את כל הדרך מתחילת התרגיל ועד התשובה הסופית, בלי להשמיט פעולות ביניים.
...
- אל תהפוך את התשובה לפתרון תרגיל מלא אלא אם התלמיד ביקש דוגמה מפורשת.
